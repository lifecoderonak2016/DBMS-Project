...
$date = $filesop[3];
$quantity = $filesop[4];
if($iid!="" && $cid!="" && $mid!="" && $date!="" && $quantity!="" && $c>=1)
{

$sql = mysql_query("INSERT INTO orders  (IID,CID,MID,date,quantity) VALUES ('$iid','$cid','$mid','$date','$quantity')");
    $k=$k+1;
}
$c = $c + 1;
}
...
<? include("face_mask.php"); ?>
    ...
    <div class="container_query">
      <h2><font color=dimgrey face='Bangers' >Add Orders Data</font></h2>
    </div> 
