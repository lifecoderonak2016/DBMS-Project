...
if($num!="" && $cid!="" && $iid!="" && $stars!=""  && $comment!="" && $c>=1)
{

$sql = mysql_query("INSERT INTO user_rating  (No,CID,IID,stars,comment) VALUES ('$num','$cid','$iid','$stars','$comment')");
    $k=$k+1;
}
$c = $c + 1;
}
...
<? include("face_mask.php"); ?>
    ...
    <div class="container_query">
      <h2><font color=dimgrey face='Bangers' >Add User Ratings Data</font></h2>
    </div> 
