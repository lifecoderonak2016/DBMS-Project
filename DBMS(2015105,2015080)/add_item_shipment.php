...
$cid = $filesop[2];
$caddress = $filesop[3];
$no_of_days = $filesop[4];
    
if($sid!="" && $cname!="" && $cid!=""  && $caddress!=""  && $no_of_days!="" && $c>=1)
{
 
$sql = mysql_query("INSERT INTO shipment  (SID,cName,CID,cAddress,no_of_days) VALUES ('$sid','$cname','$cid','$caddress','$no_of_days')");
    $k=$k+1;
}
$c = $c + 1;
}
...
<? include("face_mask.php"); ?>
    ...
    <div class="container_query">
      <h2><font color=dimgrey face='Bangers' >Add Shipment Data</font></h2>
    </div> 
