...
<html lang="en">
   ...
   <!-- Image-1.1 -->
            ...
            <img src="img/audio5.png" width=1240px >    
            </div>      
            </div>
            </div>
            ...
            <div class="row">
            <div class="col-md-4">
            <div class="container12"><a href="<?php $yolo="show.php/link="; echo $yolo.$row['time'];?>"> 
            <img width="250" height="130" src="<?php echo $temp;?>">             
            <div class="fontforimg"> 
            <h4><font color=black>I will Add 10k Snaps for you and make your snapchat more appealing.<br><br><br><br></font></h4>              
            ...
            ?>
                ...
                <img width="250" height="130" src="img/a2.png">               
                <div class="fontforimg"> 
            ...
            ?>
                ...
                <div class="col-md-4">
                <div class="container12">
                <img width="250" height="130" src="img/fresh2.jpg"> 
                <div class="fontforimg"> 
                <h4><font color=black>I will Add 10k Snaps for you and make your snapchat more appealing.<br><br><br><br></font></h4>                         <h6><font align="center" >By Tanishqandmac</font><font color=gold> ✮✮✮✮✮</font>
                <div class="label-hd"></div>
                <div class="label-eight-k2"></div><hr>
            ...
            <div class="col-md-4">
            <div class="container12"> 
            <img width="250" height="130" src="img/dre1.png"><br>
            <div class="fontforimg"> 
            <h4><font color=black>I will Add 10k Snaps for you and make your snapchat more appealing.<br><br><br><br></font></h4>                 <h6><font align="center" >By Tanishqandmac</font><font color=gold> ✮✮✮✮✮</font>
            <div class="label-hd"></div>
            <div class="label-eight-k1"></div>
            </h6>
            </div> 
            </div>
            </div> 
            ...
            <div class="col-md-4">
            <div class="container12"> 
            <img width="250" height="130" src="img/dre2.png"><br>
            <div class="fontforimg"> 
            <h4><font color=black>I will Add 10k Snaps for you and make your snapchat more appealing.<br><br><br><br></font></h4>                 <h6><font align="center" >By Tanishqandmac</font><font color=gold> ✮✮✮✮✮</font>
            <div class="label-hd"></div>
            ...
            <div class="col-md-4">
            <div class="container12"> 
            <img width="250" height="130" src="uploads/1463998336.jpeg"><br>
            <div class="fontforimg"> 
            <h4><font color=black>I will Add 10k Snaps for you and make your snapchat more appealing.<br><br><br><br></font></h4>                 <h6><font align="center" >By Tanishqandmac</font><font color=gold> ✮✮✮✮✮</font>
            <div class="label-hd"></div>
            <div class="label-sixteen-k1"></div>
            ...
            <div class="col-md-4">
            <div class="container12"> 
            <img width="250" height="130" src="img/fresh4.jpg"><br>
            <div class="fontforimg"> 
            <h4><font color=black>I will Add 10k Snaps for you and make your snapchat more appealing.<br><br><br><br></font></h4>                 <h6><font align="center" >By Tanishqandmac</font><font color=gold> ✮✮✮✮✮</font>
            <div class="label-hd"></div>
            <div class="label-thirtytwo-k1"></div>
            </h6>
            </div> 
            </div>
            </div> 
