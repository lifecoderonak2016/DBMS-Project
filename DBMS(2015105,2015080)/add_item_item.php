...
if($iid!="" && $price!="" && $iname!="" && $descrip!="" && $dop!="" && $mid!="" && $c>=1)
{

$sql = mysql_query("INSERT INTO Item_attribute  (IID,MID,price,iName,Description,date_of_publish) VALUES ('$iid','$mid','$price','$iname','$descrip','$dop')");
    $k=$k+1;
}
$c = $c + 1;
}
...
<? include("face_mask.php"); ?>
    ...
    <div class="container_query">
      <h2><font color=dimgrey face='Bangers' >Add Items Data</font></h2>
    </div> 
