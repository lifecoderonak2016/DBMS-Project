...
$mname = $filesop[2];
$mlocation = $filesop[3];   
if($mid!="" && $rating!="" && $mname!="" && $mlocation!="" && $c>=1)
{

$sql = mysql_query("INSERT INTO manufacturer  (MID,rating,mName,mLocation) VALUES ('$mid','$rating','$mname','$mlocation')");
    $k=$k+1;
}
$c = $c + 1;
}
...
<? include("face_mask.php"); ?>
    ...
    <div class="container_query">
      <h2><font color=dimgrey face='Bangers' >Add Manufacturers Data</font></h2>
    </div> 
